...
* Today screen is where the app shines:
  ...
  * The task polar tracks should stack in concentric radius, not overlap
  * Each task has label, start and stop (or all day -- full circle), color, date and repeat options, can be snoozed and completed
...
* The Tasks screen lets you manage your tasks, and should work like a typical alarm app:
  * At the top is the date, and Prev/Next day buttons
  * A list of tasks for the day is shown, including those are assigned to the day due to repeat rules
  * Each task is collapsed into simple view mode (color, label, timing, repeats) and can be expanded
